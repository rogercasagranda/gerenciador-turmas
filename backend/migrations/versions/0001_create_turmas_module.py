...
def upgrade():
    ...
    op.create_table(
        'professor',
        sa.Column('id', sa.Integer(), primary_key=True, autoincrement=True),
        sa.Column('user_id', sa.Integer(), sa.ForeignKey('usuarios.id_usuario'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('coordenador_id', sa.Integer(), sa.ForeignKey('professor.id'), nullable=True)
    )
    # Tabela disciplina
    op.create_table(
        'disciplina',
    ...
    op.create_table(
        ...
        sa.Column('professor_responsavel_id', sa.Integer(), sa.ForeignKey('professor.id'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('responsavel_id', sa.Integer(), sa.ForeignKey('responsavel.id'), nullable=False),
